...
export default function Dashboard({ user }) {
  ...
  const riskChartData = schedules.slice(0,6).map(s => ({ name: s.activity?.length > 10 ? s.activity.slice(0,10)+'…' : s.activity, risk: s.riskScore }))
  const triggerCounts = {}
    ...
    <div>
      ...
      <div className="form-card">
        ...
        {data?.recentBreakdowns?.length ? (
          <table>
            <thead><tr><th>Date</th><th>Trigger</th><th>Intensity</th><th>Duration</th></tr></thead>
            <tbody>
